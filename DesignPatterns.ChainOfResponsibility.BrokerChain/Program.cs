...
namespace DesignPatterns.ChainOfResponsibility.BrokerChain
{
    ...
    public class DoubleAttackModifier : CreatureModifier
    {
        ...
        {
            if (q.CreatureName == creature.Name && q.WhatToQuery == Query.Argument.Attack) q.Value *= 2;
        }
    }
    ...
    public class IncreaseDefenseModifier : CreatureModifier
    {
        ...
        protected override void Handle(object sender, Query q)
        {
            if (q.CreatureName == q.CreatureName && q.WhatToQuery == Query.Argument.Defense) q.Value += 2;
        }
    }
