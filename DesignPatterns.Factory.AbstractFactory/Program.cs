...
namespace DesignPatterns.Factory.AbstractFactory
{
    ...
    internal class TeaFactory : IHotDrinkFactory
    {
        ...
        {
            Console.WriteLine($"Put in a bag, boil water, put {amount} ml, add lemon, enjoy");
            return new Tea();
        }
    }
    ...
    public class HotDrinkMachine
    {
        ...
        //                Type.GetType("DesignPatterns." + Enum.GetName(typeof(AvailableDrink), drink) + "Factory") ?? throw new InvalidOperationException());
